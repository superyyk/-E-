<template>
	<view>
		...
		<!-- <image src="../../static/tony-scroll/back.png" mode=" aspectFill" style="position: fixed; top: 0px; right: 0px; width: 100%;"></image> -->
		<view class="u-f u-f-ajc" style="font-size: 24px; font-weight: 600; padding: 10px;">欢迎使用.{{Config.app_name}}！</view>
        <view class="u-f-dc u-f-ajc u-f-ac">
			<image :src="getImgsrc('logo.png')" mode="aspectFill" style="width: 55px;height: 55px; border-radius: 50px;"></image>
			<text>{{Config.app_name}}登陆</text>
		</view>
		...
		<view class="u-f-dc m-t-10">
			<view class="u-f-dr u-f-ac">
				<view>
					<image :src="getImgsrc('shouji002.png')" mode="aspectFit" style="width: 20px; height: 35px;"></image>
				</view>
				<view class="m-l-10" style="color: #8170fe; font-size:x-large; font-weight: bold; ">
					<input v-model="phoneNum" @input="onKeyInput" type="number" maxlength="11" confirm-type="send" value="" placeholder="手机号" />
				</view>
			</view>
		...
		<view class="u-f-dc m-t-10">
			<view class="u-f-dr u-f-ac">
				<view>
					<image :src="getImgsrc('yanzhengma002.png')" mode="aspectFit" style="width: 20px; height: 35px;"></image>
				</view>
			...
			<!-- 密码登录 -->		
			<view v-show="is_pass_word" class="u-f-dc m-t-10">
				<view class="u-f-dr u-f-ac">
					<view>
						<image :src="getImgsrc('mima.png')" mode="aspectFit" style="width: 20px; height: 35px;"></image>
					</view>
					<view class="m-l-10" style="color: #8170fe; font-size:larger; font-weight: bold; ">
						<input v-model="pass_word"  type="password"  maxlength="20" confirm-type="send" value="" placeholder="登陆密码默认123456" />
					</view>
				</view>
				<view class="hr-c-base" style="width: 90%;"></view>
			</view>
...
<!-- 		<view class="u-f-dr p-10 u-f-ac">
		...
		<!-- <view  style="width: 50%;  color: #FFFFFF; border-radius: 5px; margin-top: 15px; height: 45px;text-align: center; font-size: large; padding: 5px 30px; background-color:#f9710b;" >
			<text   @click="login">立即登录</text>
			</view> -->
			<button type="default" @click="login()" style="background-color:#FF3333 ; color: #FFFFFF; width: 150px;">立即登陆</button>
			
		<!-- <view v-if="is_pass_word==true" style="width: 50%;  color: #FFFFFF; border-radius: 5px; margin-top: 15px; height: 45px;text-align: center; font-size: large; padding: 5px 30px; background-color:#f9710b;"  @click="login_by_password">密码登录</view>	 -->
		
		
	<!-- 	<view class="u-f-dr u-f-ac p-8">
			<text style="color: #8B8E8E;">还没有Lcat Pool账户？</text>
			...
			login() {
				...
				if (!num.test(this.code)) {
					...
					//console.log(_self.code)
						...
						uni.request({
						url: this.tp_url + 'c_login_confirm',
